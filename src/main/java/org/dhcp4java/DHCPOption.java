...
public class DHCPOption implements Serializable, IDHCPOption {
	...
	/**
	 * Raw bytes value of the option. Some methods are provided for higher level of
	 * data structures, depending on the <tt>code</tt>.
	 */
	private final byte[] value;

	/**
	 * Used to mark an option as having a mirroring behaviour. This means that this
	 * option if used by a server will first mirror the option the client sent then
	 * provide a default value if this option was not present in the request.
	 * 
	 * <p>
	 * This is only meant to be used by servers through the <tt>getMirrorValue</tt>
	 * method.
	 */
	 ...
	 * 
	 * <p>
	 * Note: you must not prefix the value by a length-byte. The length prefix will
	 * be added automatically by the API.
	 * 
	 * <p>
	 * If value is <tt>null</tt> it is considered as an empty option. If you add an
	 * empty option to a DHCPPacket, it removes the option from the packet.
	 * 
	 * <p>
	 ...
	 *
	 * <p>
	 * This multi-line string details: the static, options and padding parts of the
	 * object. This is useful for debugging, but not efficient.
	 *
	 * @param buffer the string builder the string representation of this object
	 *               should be appended.
	 */
	 ...
	 * @return byte[] buffer to use with <tt>setOptionRaw</tt>, <tt>null</tt> if
	 *         list is null
	 ...
	 * 
	 * <p>
	 * LinkedHashMap are preferred as they preserve insertion order. Regular HashMap
	 * order is randon.
	 * 
	 ...
	 * 
	 * <p>
	 * The type is returned as a <tt>Class</tt> object:
	 * <ul>
	 ...
	 * 
	 * <p>
	 * Please use <tt>getSimpleName()</tt> methode of <tt>Class</tt> object for the
