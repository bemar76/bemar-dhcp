...
public class DHCPServlet {
	...
	/**
	 * Initialize servlet. Override this method to implement any initialization you
	 * may need.
	 * 
	 * <p>
	 * This method is called once at stratup, before any request is passed to the
	 * servlet. A properties is passed to the servlet to read whatever parameters it
	 * needs.
	 * 
	 * <p>
	 * There is no default behaviour.
	 * 
	 * @param props a Properties containing parameters, as passed to
